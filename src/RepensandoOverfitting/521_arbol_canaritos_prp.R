...
setwd( "C:\\Users\\USER\\Documents\\utnpracticas\\mde\\" )  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
setwd("C:\\Users\\USER\\Documents\\utnpracticas\\mde\\exp\\ST5210\\")   #Establezco el Working Directory DEL EXPERIMENTO
