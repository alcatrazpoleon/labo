...
param_basicos  <- list( "cp"=         -0.347,  #complejidad minima
                        "minsplit"=   1474,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  296,     #minima cantidad de registros en una hoja
